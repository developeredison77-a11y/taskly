                ...
                <div className="grid grid-cols-7 gap-1">
                    ...
                    {calendarData.map((day, index) => (
                        <div
                            ...
                            `}
                            onClick={() => auth?.permissions?.includes('timesheet_create') ? (day.entries.length > 0 ? openDayView(day.date) : addTimeEntry(day.date)) : ''}
                        >
                            ...
                            {(day.entries.length === 0 && day.isCurrentMonth && auth?.permissions?.includes('timesheet_create')) && (
