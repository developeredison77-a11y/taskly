                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            currencies.map((currency: CurrencyProps) => (
                                                                <SelectItem key={currency.id} value={currency.code}>
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        {currency.is_default && (
                                                                            <span className="ml-2 text-xs text-primary">({t('Default')})</span>
                                                                        )}
                                                                    </div>
                                                                </SelectItem>
                                                            ))
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="0">{t('0 (e.g., 1234)')}</SelectItem>
                                                    <SelectItem value="1">{t('1 (e.g., 1234.5)')}</SelectItem>
                                                    <SelectItem value="2">{t('2 (e.g., 1234.56)')}</SelectItem>
                                                    <SelectItem value="3">{t('3 (e.g., 1234.567)')}</SelectItem>
                                                    <SelectItem value="4">{t('4 (e.g., 1234.5678)')}</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value=",">{t('Comma (1,234.56)')}</SelectItem>
                                                    <SelectItem value=".">{t('Dot (1.234,56)')}</SelectItem>
                                                    <SelectItem value=" ">{t('Space (1 234.56)')}</SelectItem>
                                                    <SelectItem value="none">{t('None (123456.78)')}</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
