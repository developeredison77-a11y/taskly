...
export function HongKong({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t, invoiceLogo, companyLogo }: any) {
  ...
  return (
    <div style={{ fontFamily: 'inherit', margin: 0, padding: 0, boxSizing: 'border-box' }}>
      <div style={{ width: '100%', margin: '0 auto', background: '#ffffff', boxShadow: '0 0 10px #ddd' }}>
        <div style={{ borderTop: `15px solid ${color}`, background: '#f8f8f8', width: '100%' }}>
        ...
        <div style={{ padding: '30px 25px 30px 25px', borderBottom: `15px solid ${color}` }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              <tr>
