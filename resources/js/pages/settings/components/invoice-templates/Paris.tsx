...
export function Paris({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t, invoiceLogo, companyLogo }: any) {
    ...
    <div style={{ fontFamily: 'inherit', margin: 0, padding: 0, boxSizing: 'border-box' }}>
      <div style={{ width: '100%', margin: '0 auto', background: '#ffffff', boxShadow: '0 0 10px #ddd' }}>
        <div style={{ padding: '15px 0 15px 30px', position: 'relative', paddingRight: '30px' }}>
          ...
          <h3 style={{ display: 'inline-block', textTransform: 'uppercase', fontSize: '40px', fontWeight: 'bold', borderTop: `5px solid ${borderColor}`, paddingTop: '15px', margin: '0' }}>{translate('INVOICE')}</h3>
          <div style={{ maxWidth: '114px', maxHeight: '114px', marginTop: '5px', marginLeft: '10', marginRight: '0', background: '#ffffff' }}>
            {showQr && (
              ...
              <tr style={{ verticalAlign: 'top' }}>
                <td style={{ padding: '0', verticalAlign: 'top' }}>
                  <p style={{ margin: '0', lineHeight: '1.5' }}>
                    <b style={{ color: borderColor }}>{translate('FROM')}:</b><br />
                ...
                <td style={{ padding: '0', verticalAlign: 'top' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <tbody>
                      <tr>
                        <td style={{ padding: '0', fontSize: '13px', fontWeight: '600', color }}></td>
                        <td style={{ padding: '0', textAlign: 'right', fontSize: '13px', fontWeight: '600' }}>
                          <b>{translate('Number')}:</b> {invoiceData.invoice_number}
                        </td>
                      </tr>
                      <tr>
                        <td style={{ padding: '0', fontSize: '13px', fontWeight: '600', color }}></td>
                        <td style={{ padding: '0', textAlign: 'right', fontSize: '13px', fontWeight: '600' }}>
                          <b>{translate('Valid Until')}:</b> {new Date(invoiceData.due_date).toLocaleDateString()}
                        </td>
                      </tr>
                      <tr>
