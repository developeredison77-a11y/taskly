...
export function Tokyo({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t, invoiceLogo, companyLogo }: any) {
                    ...
                    <tbody>
                      <tr>
                        <td colSpan={2} style={{ padding: '0 0 15px 0' }}>
                          {showQr && (
                            <div style={{ maxWidth: '114px', maxHeight: '114px', marginLeft: 'auto', background: '#ffffff' }}>
