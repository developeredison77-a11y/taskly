...
//   }, [flash?.success, flash?.error]);
  ...
  const { data, setData, post, processing, errors } = useForm<PaymentSettings>({
    ...
    paytabs_region: settings.paytabs_region || 'GLO',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('payment.settings'), {
      ...
      onError: (errors) => {
        ...
        toast.error(errorMessages[0] as string || t('Failed to update payment settings'));
      }
    });
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Razorpay API keys from your")}
              >
                <div className="space-y-4">
                  <PaymentModeSelector
                    value={data.razorpay_mode}
                    onChange={(mode) => setData('razorpay_mode', mode)}
                    name="razorpay"
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <PaymentInputField
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your MercadoPago access token from your")}
              >
                <div className="space-y-4">
                  <PaymentModeSelector
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Paystack API keys from your")}
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <PaymentInputField
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Flutterwave API keys from your")}
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <PaymentInputField
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Tap API key from your")}
              >
                <PaymentInputField
                  id="tap_secret_key"
                  label={t("Secret Key")}
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Xendit API key from your")}
              >
                <PaymentInputField
                  id="xendit_api_key"
                  label={t("API Key")}
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your PayTR credentials from your")}
              >
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Mollie API key from your")}
              >
                <PaymentInputField
                  id="mollie_api_key"
                  label={t("API Key")}
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your PayTabs credentials from your")}
              >
                <div className="space-y-4">
                  <PaymentModeSelector
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={data.paytabs_region} onValueChange={(value) => setData('paytabs_region', value)}>
                        ...
                        <SelectContent>
                          <SelectItem value="GLO">GLOBAL</SelectItem>
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your Skrill credentials from your")}
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <PaymentInputField
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your CoinGate API token from your")}
              >
                <div className="space-y-4">
                  <PaymentModeSelector
              ...
              <PaymentMethodCard
                ...
                helpText={t("Get your PayFast credentials from your")}
              >
                <div className="space-y-4">
                  <PaymentModeSelector
