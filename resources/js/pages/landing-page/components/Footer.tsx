...
export default function Footer({ flash, settings, sectionData = {}, brandColor = '#3b82f6', logoLight, logoDark }: FooterProps) {
              ...
              <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    type="submit"
                    disabled={processing}
                    className="text-white px-6 py-3 rounded-lg transition-colors cursor-pointer font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[120px]"
